...
class DCM_Manager(object):
    ...
    def get_image(self, folder):
        ...
        data_folder = self.data_folder
        self.current_data_folder = os.path.join(data_folder, folder)

        dcm_files = sitk.ImageSeriesReader().GetGDCMSeriesFileNames(self.current_data_folder)
        ...
        logger.debug(
            'Generate img_array from {} with shape of {}'.format(self.current_data_folder, img_array.shape))
